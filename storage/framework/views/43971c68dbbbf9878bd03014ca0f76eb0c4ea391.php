...
<?php $__env->startSection('page_header'); ?>
    <div class="container-fluid">
        ...
        <form action="<?php echo e(route('import')); ?>" method="POST" enctype="multipart/form-data" style="display:inline-block;">
            <?php echo csrf_field(); ?>
            ...
            <?php endif; ?>
            <?php if(session('oshibka')): ?>
                <div class="alert alert-danger">
                    <?php echo e(session('oshibka')); ?>
        ...
        <form action="<?php echo e(route('export')); ?>" method="POST" style="display:inline-block;">
            <?php echo csrf_field(); ?>
            <button type="submit" class="btn btn-success btn-add-new">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/0/004/domains/proffmetall.testkz.ru/resources/views/vendor/voyager/table/browse.blade.php ENDPATH**/ ?>